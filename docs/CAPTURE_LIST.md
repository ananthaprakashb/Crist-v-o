...
- Do not include API keys, environment-variable values, terminal secrets, or private account information.
...
- Slide 3: Evidence / verifier / source-change architecture.
